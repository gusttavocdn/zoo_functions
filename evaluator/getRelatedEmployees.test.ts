import { isManager, getRelatedEmployees } from '../src/getRelatedEmployees';
...
describe('4 - Crie a gestão das pessoas colaboradoras de acordo com o respectivo gerente', () => {
  ...
  it('retorna uma array com o nome das pessoas colaboradoras do respectivo gerente passado pelo id', () => {
  ...
  it('dispara erro com a mensagem "O id inserido não é de uma pessoa colaboradora gerente!", quando o id inserido não for de uma pessoa colaboradora genrente', () => {
    ...
    expect(() => getRelatedEmployees(actual)).toThrow(
